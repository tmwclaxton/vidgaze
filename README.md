...
1. Clone the repo
2. Run `sail build` (uses PHP 8.3; rebuild after upgrading from older images)
3. Run `sail up`
...
- [Laravel] 13.x (requires PHP 8.3+) — A web application framework with expressive, elegant syntax.
