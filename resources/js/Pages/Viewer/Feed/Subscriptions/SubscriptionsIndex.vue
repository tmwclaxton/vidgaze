...
<template>
    ...
    <ConsistentPadding>
        <div class="flex flex-row w-full  justify-center">
            <TitleComponent text="Subscriptions">
                <font-awesome-icon :icon="['fas', 'heart']" class="my-auto h-5"/>
            </TitleComponent>
        ...
        <row-divider class="mt-4 mb-3 rounded-2xl opacity-0"></row-divider>

        <div class="flex flex-col gap-y-2" v-if="streams.length > 0">
<!--            <TitleComponent text="Livestreams" class="my-4 mb-8">-->
<!--                <font-awesome-icon :icon="['fas', 'tower-broadcast']" class="h-6 w-6 my-auto" /> -->
<!--            </TitleComponent>-->
        ...
        <row-divider class="mt-6 mb-3 rounded-2xl" v-if="videos.length > 0 && streams.length > 0"></row-divider>
...
<!--            </TitleComponent>-->
            ...
            <div class="pt-6 px-3 xs:px-0 flex
                        grid grid-cols-1 xs:grid-cols-2 ld:grid-cols-3 lg:grid-cols-4 lg:grid-cols-5 4xl:grid-cols-6 gap-4 ">
