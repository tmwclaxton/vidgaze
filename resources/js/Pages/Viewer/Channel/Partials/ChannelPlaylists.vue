...
<template>
    ...
    <div class=" mx-auto  pt-10 justify-center flex flex-col">
        <div class="mx-10 my-auto flex-col  flex   dark:bg-transparent  ">
            ...
            <div class="flex flex-col space-y-2 items-center justify-center anim ate-pulse">
                ...
                <p class="  text-zinc-600 dark:textDark font-bold text-4xl pt-8 text-center">Channel playlists are under Construction</p>
