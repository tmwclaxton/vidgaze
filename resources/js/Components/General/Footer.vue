    ...
    <div class="p-4 w-full   sm:p-6 sm:px-10  ">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-zinc-900 uppercase dark:text-white">App Stores</h2>
                ...
                <div>
                    ...
                    <ul class="text-zinc-600 dark:text-zinc-200">
                        <li class="mb-4">
                            <a href="https://www.instagram.com/vidgaze/" target="_blank" class="hover:underline ">Instagram</a>
                        </li>
                        <li>
                            <a href="https://discord.gg/5nvsYJPTcX" target="_blank" class="hover:underline">Discord</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/vidgaze" target="_blank"  class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/vidgaze/" target="_blank"  class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
                ...
                <a href="https://www.twitter.com/vidgaze" target="_blank"  class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path
                ...
                <a href="https://github.com/tmwclaxton/vidgaze" target="_blank"  class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
