...
<template>
    ...
    <div class="relative flex" v-if="$page.props.auth.user.creator != null">
        <Dropdown align="right" width="64" distance="1.5"  >
            <template #trigger>
                <span class="inline-flex rounded-md   ">
                    ...
                    >
                        <img class="w-full   "
                             v-bind:src="$page.props.auth.user.creator.banner_url">
                        <img class="h-8 aspect-square rounded-full bg-zinc-800 aspect-square  "
                             v-bind:src="$page.props.auth.user.creator.avatar_url">
